...
void setup() {
  ...
  stepper.setMaxSpeed(400);  // Too much can cause driver to heat up due to the driver's current limits, ideally should be 1000
  stepper.setSpeed(400); // Limited by the max speed
