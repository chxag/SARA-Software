...
roscomm.init_kait(target_pose, target)

# Conduct client connection
navclient = init_client_nav_ros()
navclient = actionlib.SimpleActionClientListener('move_base',NULL, MoveBaseAction, 2)
...
if not finished:
    rospy.logerr("Action server not available!", NULL)
else:
